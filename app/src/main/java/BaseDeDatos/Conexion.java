...
public class Conexion extends AsyncTask<String,Void, String> {
    ...
    //-MODIFICAR PRODUCTO (ID USUARIO, PRODUCTO)
    ...
    //-ALTA PEDIDO (LISTADO DE PRODUCTOS, IDUSUARIO) A TODOS LOS PRODUCTOS SE DEBERA RESTAR LA CANTIDAD EN EL STOCK
    ...
    //-EXISTE CALIFICACION (IDPEDIDO, IDUSUARIO) DEBERA VERIFICAR SI EXISTE PARA SABER SI ES UN ALTA O UN UPDATE
    //-CALIFICAR (ID PEDIDO, IDUSUARIO) DEBERA APLICAR LA CALIFICACION A TODOS LOS PRODUCTOS DE ESE PEDIDO
    //-MODIFICAR CALIFICACION (ID PEDIDO, IDUSUARIO) DEBERA APLICAR LA CALIFICACION A TODOS LOS PRODUCTOS DE ESE PEDIDO
    ...
    //-CONSULTAR HISTORIAL (FILTROS, IDUSUARIO) SE SUMARA LOS PEDIDOS Y CALIFICACION PERSONAL EN CASO DE TENERLA
